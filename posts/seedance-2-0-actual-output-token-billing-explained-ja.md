...
slug: "seedance-2-0-actual-output-token-billing-explained-ja"
summary: "Seedance 2.0がタスク完了後に返される実際のoutput tokensで課金される仕組みを、720p/4秒の実測例で解説します。"
...
meta_title: "Seedance 2.0の実課金：固定の秒単価ではなくoutput tokensで決まる理由"
meta_description: "Seedance 2.0がタスク完了後に返される実際のoutput tokensで課金される仕組みを、720p/4秒の実測例で解説します。"
