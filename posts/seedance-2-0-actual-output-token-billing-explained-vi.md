---
title: "Cách tính phí thực tế của Seedance 2.0: không có giá cố định theo giây"
slug: "seedance-2-0-actual-output-token-billing-explained-vi"
summary: "Giải thích cách Seedance 2.0 tính phí theo output tokens thực tế sau khi tác vụ hoàn tất, kèm hai ví dụ đo thực tế 720p/4s."
...
meta_title: "Cách tính phí thực tế của Seedance 2.0: không có giá cố định theo giây"
meta_description: "Giải thích cách Seedance 2.0 tính phí theo output tokens thực tế sau khi tác vụ hoàn tất, kèm hai ví dụ đo thực tế 720p/4s."
...
## Ví dụ thực tế 2: tạo video từ reference video
...
Seedance 2.0 không có giá cố định theo giây. Hệ thống tính phí theo output tokens thực tế sau khi tác vụ hoàn tất. Ta có thể suy ra chi phí trung bình mỗi giây từ các tác vụ đã hoàn thành, nhưng không có một tỷ lệ tokens/giây cố định cho mọi trường hợp.
...
Cách nói an toàn nhất với khách hàng: Seedance 2.0 được tính phí theo output tokens thực tế. Trong hai bài test 720p/4s hiện tại, text-to-video đơn giản khoảng $0.14/s, còn tạo video từ reference video khoảng $0.17/s.
