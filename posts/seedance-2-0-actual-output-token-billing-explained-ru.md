---
title: "Реальный биллинг Seedance 2.0: почему нет фиксированной цены за секунду"
slug: "seedance-2-0-actual-output-token-billing-explained-ru"
summary: "Разбираем, как Seedance 2.0 тарифицируется по фактическим output tokens после завершения задачи, на двух тестах 720p/4s."
...
meta_title: "Реальный биллинг Seedance 2.0: почему нет фиксированной цены за секунду"
meta_description: "Разбираем, как Seedance 2.0 тарифицируется по фактическим output tokens после завершения задачи, на двух тестах 720p/4s."
...
Самое безопасное объяснение клиенту: Seedance 2.0 оплачивается по фактическим output tokens. В текущих тестах 720p/4s простой text-to-video стоил около $0.14/s, а generation с reference video — около $0.17/s.
